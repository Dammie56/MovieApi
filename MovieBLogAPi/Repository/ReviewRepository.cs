...
namespace MovieBlogAPI.Repository
{
    public class ReviewRepository : IReviewRepository
    {
        ...
        public ReviewRepository(MovieDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public bool ReviewExists(int reviewerId, int movieId)
        {
            return _context.Reviews.Any(r => r.Reviewer.Id == reviewerId && r.Movie.Id == movieId);
        }
