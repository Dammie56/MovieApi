...
namespace MovieBlogAPI.Controllers
{
    ...
    public class ReviewerController : Controller
    {
        ...
        {
            var reviewers = _mapper.Map<List<GetReviewerDto>>(_reviewerRepository.GetReviewers());
        ...
        public IActionResult GetReviewer(int reviewerId)
        {
            ...
            var reviewer = _mapper.Map<GetReviewerDto>(_reviewerRepository.GetReviewer(reviewerId));
        ...
        public IActionResult UpdateReviewer(int reviewerId, [FromBody] ReviewerDto updatedReviewer)
        {
            ...
            if (!_reviewerRepository.UpdateReviewer(reviewerId, reviewerMap))
            {
